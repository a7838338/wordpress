...
?>
		<div class="theme-info-wrapper">
			...
			<p class="easy-mart-actions">
				...
				<a href="<?php echo esc_url( apply_filters( 'easy_mart_pro_theme_url', 'https://demo.codevibrant.com/easy-mart/' ) ); ?>" class="button button-secondary docs" target="_blank"><?php esc_html_e( 'View Demo', 'easy-mart' ); ?></a>
				...
				<a href="<?php echo esc_url( apply_filters( 'easy_mart_pro_theme_url', 'https://wordpress.org/support/theme/easy-mart/reviews/?filter=5' ) ); ?>" class="button button-secondary docs" target="_blank"><?php esc_html_e( 'Rate this theme', 'easy-mart' ); ?></a>
			</p>
