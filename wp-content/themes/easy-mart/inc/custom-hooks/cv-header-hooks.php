...
add_action( 'easy_mart_top_header_sec', 'easy_mart_top_header_wishlist_btn', 30 );
add_action( 'easy_mart_top_header_sec', 'easy_mart_top_header_nav_menu', 40 );
add_action( 'easy_mart_top_header_sec', 'easy_mart_top_header_end', 50 );
